  ...
  return (
    <div className="App">
      <Switch>
        ...
        <Route exact path="/:listType/:movieName" component={(props) => (<Details {...props} api_key={API_KEY} now_playing_api={now_playing_api} popular_api={popular_api} upcoming_api={upcoming_api} />)} />
      </Switch>
    </div>
  );
  }
